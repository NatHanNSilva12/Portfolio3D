    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          ...
          showAlert({
            show: true,
            text: "Eita! Eu não recebi sua mensagem 😢",
            type: 'danger',
          });
        },
      );
      ...
      <div className="relative min-h-screen flex items-center justify-center flex-col">
        ...
        <div className="contact-container">
          ...
          <p className="text-lg text-white-600 mt-3">
            Deseja um sistema completo, ou até mesmo um simples site? Estou aqui para te ajudar! Envie agora sua mensagem e vamos negociar!
          </p>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col space-y-7">
            ...
            <label className="space-y-3">
              <span className="field-label">Endereço Email</span>
              <input
                type="email"
                name="email"
                value={form.email}
